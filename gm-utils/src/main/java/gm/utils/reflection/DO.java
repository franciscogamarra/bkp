...
public abstract class DO<T> {
	...
	public Integer getInt(Atributo a){
		return IntegerParse.toInt(get(a));
	}
	public Integer getInt(String field){
		return IntegerParse.toInt(get(field));
	}
	public String getString(String field) {
		...
		if (f.isDate()) {
			...
			if ( (annotation != null) && UCompare.equals(annotation.annotationType(), TemporalType.DATE) ) {
			}
...
//		Atributo a = atributo(field);
//		if (a == null) {
//			throw UException.runtime("Campo não encontrado: " + getClass().getSimpleName() + " : " + field );
//		}
//		return a.get(object);
	}
	...
	public Atributos as() {
		if ( as == null ) {
			as = AtributosBuild.get(UClass.getClass(object));
		}
		return as;
	}
	...
	public Atributos asPersist() {
		if ( as == null ) {
			as = AtributosBuild.getPersists(UClass.getClass(object), false);
		}
		return as;
	}
