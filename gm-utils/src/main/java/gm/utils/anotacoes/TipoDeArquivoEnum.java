...
public enum TipoDeArquivoEnum {
	IMAGEM(1) {
		...
		public ExtensaoDeArquivoEnum[] extensoes() {
			return new ExtensaoDeArquivoEnum[] { ExtensaoDeArquivoEnum.JPG, ExtensaoDeArquivoEnum.JPEG, ExtensaoDeArquivoEnum.PNG, ExtensaoDeArquivoEnum.GIF, };
		}
		@Override
	...
	TEXTO(2) {
		@Override
		public ExtensaoDeArquivoEnum[] extensoes() {
			return new ExtensaoDeArquivoEnum[] { ExtensaoDeArquivoEnum.PDF, ExtensaoDeArquivoEnum.DOC, ExtensaoDeArquivoEnum.DOCX,
