...
//
	...
	private void montaSql() {
		...
		if (recents != null && !recents.isEmpty()) {
			sql += " and (a.id+1 not in ("+recents.joinString(",") + "))";
		}
...
//	}
	...
	private static Integer selectInt(String sql, Integer def) {
		...
		return IntegerParse.toIntDef(con.selectInt(sql), def);
	}
...
//		throw new MessageException("não deve ser usado");
