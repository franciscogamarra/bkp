...
//	}
	...
	public Integer getInt(int x) {
		return IntegerParse.toInt(get(x));
	}
	...
	public Integer getInt(String delimitador) {
		return IntegerParse.toInt(get(delimitador));
	}

	public String get(String delimitador) {
		String x = StringBeforeFirst.get(s, delimitador);
		s = StringAfterFirst.get(s, delimitador);
		return x;
	}
}
