...
public class PropriedadesDeEmailDeProvedoresConhecidos {
	...
	public static final Properties COOPERFORTE = new Properties();

	static {
//		COOPERFORTE.put("mail.smtp.host", "smtp.cooperforte.coop");
//		COOPERFORTE.put("mail.smtp.socketFactory.port", "465");
//		COOPERFORTE.put("mail.smtp.socketFactory.class", "javax.net.ssl.SSLSocketFactory");
//		COOPERFORTE.put("mail.smtp.auth", "false");
//		COOPERFORTE.put("mail.smtp.port", "25");

		COOPERFORTE.put("mail.smtps.host", "smtp.cooperforte.coop");
		COOPERFORTE.put("mail.smtp.host", "smtp.cooperforte.coop");
		COOPERFORTE.put("mail.smtp.auth", "false");
		COOPERFORTE.put("mail.smtp.port", "25");
		COOPERFORTE.put("mail.smtps.auth", "false");
		COOPERFORTE.put("mail.smtps.quitwait", "false");

//		COOPERFORTE.put("mail.smtp.socketFactory.port", "465");
//		COOPERFORTE.put("mail.smtp.socketFactory.class", "javax.net.ssl.SSLSocketFactory");
//		COOPERFORTE.put("mail.smtp.socketFactory.fallback", "false");
